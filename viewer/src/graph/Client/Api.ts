import { Branch, New, Property, Space, Sha, Theorem, Trait } from '../../types'
...
export default interface Api {
  ...
  resetBranch: (branch: Branch, to: Sha) => Response<Sha>
  ...
  submitBranch: (name: Branch) => Response<SubmitBranch['submitBranch']>
